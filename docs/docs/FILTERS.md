...
* [danog\MadelineProto\EventHandler\Filter\FilterText(string $content, bool $caseInsensitive = false) &raquo;](https://docs.madelineproto.xyz/PHP/danog/MadelineProto/EventHandler/Filter/FilterText.html) - Allow only messages with a specific content.
