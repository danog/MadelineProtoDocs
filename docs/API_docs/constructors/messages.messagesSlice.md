...
|----------|---------------|----------|-------------|
|inexact|[Bool](/API_docs/types/Bool.md) | Optional|If set, indicates that the results may be inexact|
|count|[int](/API_docs/types/int.md) | Yes|Total number of messages in the list|
|next\_rate|[int](/API_docs/types/int.md) | Optional|Rate to use in the `offset_rate` parameter in the next call to [messages.searchGlobal](../methods/messages.searchGlobal.md)|
...
|chats|Array of [Chat](/API_docs/types/Chat.md) | Yes|List of chats mentioned in messages|
