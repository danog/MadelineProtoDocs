...
|----------|---------------|----------|-------------|
|id|[long](/API_docs/types/long.md) | Yes|Random file identifier created by the client|
|parts|[int](/API_docs/types/int.md) | Yes|Number of parts saved|
|name|[string](/API_docs/types/string.md) | Yes|Full name of the file|
|md5\_checksum|[string](/API_docs/types/string.md) | Yes|In case the file's [md5-hash](https://en.wikipedia.org/wiki/MD5#MD5_hashes) was passed, contents of the file will be checked prior to use|
