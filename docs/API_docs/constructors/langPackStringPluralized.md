...
|zero\_value|[string](/API_docs/types/string.md) | Optional|Value for zero objects|
|one\_value|[string](/API_docs/types/string.md) | Optional|Value for one object|
|two\_value|[string](/API_docs/types/string.md) | Optional|Value for two objects|
|few\_value|[string](/API_docs/types/string.md) | Optional|Value for a few objects|
|many\_value|[string](/API_docs/types/string.md) | Optional|Value for many objects|
|other\_value|[string](/API_docs/types/string.md) | Yes|Default value|
