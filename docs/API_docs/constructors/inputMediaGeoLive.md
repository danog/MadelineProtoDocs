...
|----------|---------------|----------|-------------|
|stopped|[Bool](/API_docs/types/Bool.md) | Optional|Whether sending of the geolocation was stopped|
|geo\_point|[InputGeoPoint](/API_docs/types/InputGeoPoint.md) | Optional|Current geolocation|
...
|period|[int](/API_docs/types/int.md) | Optional|Validity period of the current location|
