...
|admin\_rights|[ChatAdminRights](/API_docs/types/ChatAdminRights.md) | Yes|Creator admin rights|
|rank|[string](/API_docs/types/string.md) | Optional|The role (rank) of the group creator in the group: just an arbitrary string, `admin` by default|
