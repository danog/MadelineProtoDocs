...
|file\_token|[bytes](/API_docs/types/bytes.md) | Yes|File token (see [CDN files](https://core.telegram.org/cdn))|
|encryption\_key|[bytes](/API_docs/types/bytes.md) | Yes|Encryption key (see [CDN files](https://core.telegram.org/cdn))|
|encryption\_iv|[bytes](/API_docs/types/bytes.md) | Yes|Encryption IV (see [CDN files](https://core.telegram.org/cdn))|
|file\_hashes|Array of [FileHash](/API_docs/types/FileHash.md) | Yes|File hashes (see [CDN files](https://core.telegram.org/cdn))|
