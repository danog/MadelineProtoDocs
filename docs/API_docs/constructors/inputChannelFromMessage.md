...
|----------|---------------|----------|-------------|
|peer|[Username, chat ID, Update, Message or InputPeer](/API_docs/types/InputPeer.md) | Optional|The chat where the channel was seen|
|msg\_id|[int](/API_docs/types/int.md) | Yes|The message ID in the chat where the channel was seen|
