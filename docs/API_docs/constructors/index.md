...
***
<br><br>[$groupCallDonor](/API_docs/constructors/groupCallDonor.html) = \['top' => [Bool](/API_docs/types/Bool.html), 'my' => [Bool](/API_docs/types/Bool.html), 'anonymous' => [Bool](/API_docs/types/Bool.html), 'peer_id' => [Peer](/API_docs/types/Peer.html), 'stars' => [long](/API_docs/types/long.html), \];<a name="groupCallDonor"></a>  
...
***
<br><br>[$payments.starGiftActiveAuctions](/API_docs/constructors/payments.starGiftActiveAuctions.html) = \['auctions' => \[[StarGiftActiveAuctionState](/API_docs/types/StarGiftActiveAuctionState.html)\], 'users' => \[[User](/API_docs/types/User.html)\], \];<a name="payments.starGiftActiveAuctions"></a>  
...
***
<br><br>[$webPageAttributeStarGiftAuction](/API_docs/constructors/webPageAttributeStarGiftAuction.html) = \['gift' => [StarGift](/API_docs/types/StarGift.html), 'end_date' => [int](/API_docs/types/int.html), 'center_color' => [int](/API_docs/types/int.html), 'edge_color' => [int](/API_docs/types/int.html), 'text_color' => [int](/API_docs/types/int.html), \];<a name="webPageAttributeStarGiftAuction"></a>  
