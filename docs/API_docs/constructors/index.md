...
***
<br><br>[$updateGroupCallMessage](/API_docs/constructors/updateGroupCallMessage.html) = \['call' => [InputGroupCall](/API_docs/types/InputGroupCall.html), 'from_id' => [Peer](/API_docs/types/Peer.html), 'message' => [TextWithEntities](/API_docs/types/TextWithEntities.html), \];<a name="updateGroupCallMessage"></a>  
