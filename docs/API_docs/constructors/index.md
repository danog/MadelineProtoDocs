...
***
<br><br>[$account.chatThemes](/API_docs/constructors/account.chatThemes.html) = \['hash' => [long](/API_docs/types/long.html), 'themes' => \[[ChatTheme](/API_docs/types/ChatTheme.html)\], 'chats' => \[[Chat](/API_docs/types/Chat.html)\], 'users' => \[[User](/API_docs/types/User.html)\], 'next_offset' => [int](/API_docs/types/int.html), \];<a name="account.chatThemes"></a>  
...
***
<br><br>[$auth.sentCodePaymentRequired](/API_docs/constructors/auth.sentCodePaymentRequired.html) = \['store_product' => [string](/API_docs/types/string.html), 'phone_code_hash' => [string](/API_docs/types/string.html), 'support_email_address' => [string](/API_docs/types/string.html), 'support_email_subject' => [string](/API_docs/types/string.html), \];<a name="auth.sentCodePaymentRequired"></a>  
