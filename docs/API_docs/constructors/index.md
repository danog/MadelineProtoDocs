...
***
<br><br>[$inputInvoiceStarGift](/API_docs/constructors/inputInvoiceStarGift.html) = \['hide_name' => [Bool](/API_docs/types/Bool.html), 'include_upgrade' => [Bool](/API_docs/types/Bool.html), 'user_id' => [InputUser](/API_docs/types/InputUser.html), 'gift_id' => [long](/API_docs/types/long.html), 'message' => [TextWithEntities](/API_docs/types/TextWithEntities.html), \];<a name="inputInvoiceStarGift"></a>  

***
<br><br>[$inputInvoiceStarGiftTransfer](/API_docs/constructors/inputInvoiceStarGiftTransfer.html) = \['msg_id' => [int](/API_docs/types/int.html), 'to_id' => [InputUser](/API_docs/types/InputUser.html), \];<a name="inputInvoiceStarGiftTransfer"></a>  

***
<br><br>[$inputInvoiceStarGiftUpgrade](/API_docs/constructors/inputInvoiceStarGiftUpgrade.html) = \['keep_original_details' => [Bool](/API_docs/types/Bool.html), 'msg_id' => [int](/API_docs/types/int.html), \];<a name="inputInvoiceStarGiftUpgrade"></a>  
...
***
<br><br>[$messageService](/API_docs/constructors/messageService.html) = \['out' => [Bool](/API_docs/types/Bool.html), 'mentioned' => [Bool](/API_docs/types/Bool.html), 'media_unread' => [Bool](/API_docs/types/Bool.html), 'reactions_are_possible' => [Bool](/API_docs/types/Bool.html), 'silent' => [Bool](/API_docs/types/Bool.html), 'post' => [Bool](/API_docs/types/Bool.html), 'legacy' => [Bool](/API_docs/types/Bool.html), 'id' => [int](/API_docs/types/int.html), 'from_id' => [Peer](/API_docs/types/Peer.html), 'peer_id' => [Peer](/API_docs/types/Peer.html), 'reply_to' => [MessageReplyHeader](/API_docs/types/MessageReplyHeader.html), 'date' => [int](/API_docs/types/int.html), 'action' => [MessageAction](/API_docs/types/MessageAction.html), 'reactions' => [MessageReactions](/API_docs/types/MessageReactions.html), 'ttl_period' => [int](/API_docs/types/int.html), \];<a name="messageService"></a>  
...
***
<br><br>[$payments.starsRevenueStats](/API_docs/constructors/payments.starsRevenueStats.html) = \['revenue_graph' => [StatsGraph](/API_docs/types/StatsGraph.html), 'status' => [StarsRevenueStatus](/API_docs/types/StarsRevenueStatus.html), 'usd_rate' => [double](/API_docs/types/double.html), \];<a name="payments.starsRevenueStats"></a>  
...
***
<br><br>[$starGiftAttributeBackdrop](/API_docs/constructors/starGiftAttributeBackdrop.html) = \['name' => [string](/API_docs/types/string.html), 'center_color' => [int](/API_docs/types/int.html), 'edge_color' => [int](/API_docs/types/int.html), 'pattern_color' => [int](/API_docs/types/int.html), 'text_color' => [int](/API_docs/types/int.html), 'rarity_permille' => [int](/API_docs/types/int.html), \];<a name="starGiftAttributeBackdrop"></a>  
...
***
<br><br>[$starGiftUnique](/API_docs/constructors/starGiftUnique.html) = \['id' => [long](/API_docs/types/long.html), 'title' => [string](/API_docs/types/string.html), 'num' => [int](/API_docs/types/int.html), 'owner_id' => [long](/API_docs/types/long.html), 'attributes' => \[[StarGiftAttribute](/API_docs/types/StarGiftAttribute.html)\], 'availability_issued' => [int](/API_docs/types/int.html), 'availability_total' => [int](/API_docs/types/int.html), \];<a name="starGiftUnique"></a>  
...
***
<br><br>[$stats.broadcastRevenueTransactions](/API_docs/constructors/stats.broadcastRevenueTransactions.html) = \['count' => [int](/API_docs/types/int.html), 'transactions' => \[[BroadcastRevenueTransaction](/API_docs/types/BroadcastRevenueTransaction.html)\], \];<a name="stats.broadcastRevenueTransactions"></a>  

***
<br><br>[$stats.broadcastRevenueWithdrawalUrl](/API_docs/constructors/stats.broadcastRevenueWithdrawalUrl.html) = \['url' => [string](/API_docs/types/string.html), \];<a name="stats.broadcastRevenueWithdrawalUrl"></a>  
