...
***
<br><br>[$storyViews](/API_docs/constructors/storyViews.html) = \['has_viewers' => [Bool](/API_docs/types/Bool.html), 'views_count' => [int](/API_docs/types/int.html), 'reactions_count' => [int](/API_docs/types/int.html), 'recent_viewers' => \[[long](/API_docs/types/long.html)\], \];<a name="storyViews"></a>  
