...
|media\_unread|[Bool](/API_docs/types/Bool.md) | Optional|Whether the message contains unread media|
|silent|[Bool](/API_docs/types/Bool.md) | Optional|Whether the message is silent|
|post|[Bool](/API_docs/types/Bool.md) | Optional|Whether it's a channel post|
...
|from\_id|[Peer](/API_docs/types/Peer.md) | Optional|ID of the sender of this message|
|peer\_id|[Peer](/API_docs/types/Peer.md) | Yes|Sender of service message|
|reply\_to|[MessageReplyHeader](/API_docs/types/MessageReplyHeader.md) | Optional|Reply (thread) information|
|date|[int](/API_docs/types/int.md) | Yes|Message date|
|action|[MessageAction](/API_docs/types/MessageAction.md) | Optional|Event connected with the service message|
