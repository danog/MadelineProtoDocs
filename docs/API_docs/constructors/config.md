...
|pfs\_enabled|[Bool](../types/Bool.md) | Optional|Whether [pfs](https://core.telegram.org/api/pfs) was used|
...
|pinned\_infolder\_count\_max|[int](../types/int.md) | Yes|Maximum count of dialogs per folder|
