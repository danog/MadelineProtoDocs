...
**N.B.**: This Update isn't relative to the service message generated by the left event; for that see [this update](./updateNewMessage.md) with [this message](./messageService.md).
