...
|----------|---------------|----------|-------------|
|request\_write\_access|[Bool](/API_docs/types/Bool.md) | Optional|Set this flag to request the permission for your bot to send messages to the user.|
