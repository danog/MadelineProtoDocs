...
|for\_community\_peer|[Bool](/API_docs/types/Bool.html) |  | Optional|
...
$messages_Chats = $MadelineProto->channels->getAdminedPublicChannels(by_location: $Bool, check_limit: $Bool, for_personal: $Bool, for_community_peer: $Bool, );
```
