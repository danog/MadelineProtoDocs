---
title: "ephemeral.sendMessage"
description: "ephemeral.sendMessage parameters, return type and example"
grand_parent: "Telegram RPC API"
parent: "Methods"
image: https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png
redirect_from: /API_docs/methods/ephemeral_sendMessage.html
---
...
|welcome|[Bool](/API_docs/types/Bool.html) | Optional|
|anchor|[Bool](/API_docs/types/Bool.html) | Optional|
|noforwards|[Bool](/API_docs/types/Bool.html) | Optional|
|peer|[Username, chat ID, Update, Message or InputPeer](/API_docs/types/InputPeer.html) | Optional|
|receiver\_id|[Username, chat ID, Update, Message or InputUser](/API_docs/types/InputUser.html) | Optional|
...
$Updates = $MadelineProto->ephemeral->sendMessage(invert_media: $Bool, welcome: $Bool, anchor: $Bool, noforwards: $Bool, peer: $InputPeer, receiver_id: $InputUser, query_id: $long, message: 'string', entities: [$MessageEntity, $MessageEntity], parse_mode: 'string', media: $InputMedia, reply_markup: $ReplyMarkup, rich_message: $InputRichMessage, reply_to: $InputReplyTo, );
```
