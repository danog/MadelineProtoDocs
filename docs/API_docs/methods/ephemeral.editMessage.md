---
title: "ephemeral.editMessage"
description: "ephemeral.editMessage parameters, return type and example"
grand_parent: "Telegram RPC API"
parent: "Methods"
image: https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png
redirect_from: /API_docs/methods/ephemeral_editMessage.html
---
...
$Updates = $MadelineProto->ephemeral->editMessage(invert_media: $Bool, welcome: $Bool, peer: $InputPeer, receiver_id: $InputUser, id: $int, message: 'string', media: $InputMedia, entities: [$MessageEntity, $MessageEntity], parse_mode: 'string', reply_markup: $ReplyMarkup, rich_message: $InputRichMessage, );
```
