...
|----------|---------------|-------------|----------|
|animation|[InputFile](../types/InputFile.md) | Animation file to add. Only known to server animations (i. e. successfully sent via message) can be added to the list | Yes|
