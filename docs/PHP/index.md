...
* [\danog\MadelineProto\Call: Common interface implemented by every call type: one-to-one {@see VoIP} calls and {@see GroupCall}](/PHP/danog/MadelineProto/Call.html)
...
* [\danog\MadelineProto\MultiCall: Common interface for the multi-party call types — {@see GroupCall} (video chats, livestreams) and](/PHP/danog/MadelineProto/MultiCall.html)
