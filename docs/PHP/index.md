...
## Interfaces
* [\danog\MadelineProto\EventHandler\SimpleFilter\Ended](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/Ended.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\FromAdmin](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/FromAdmin.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\FromAdminOrOutgoing](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/FromAdminOrOutgoing.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasAudio](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasAudio.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasDocument](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasDocument.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasDocumentPhoto](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasDocumentPhoto.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasGif](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasGif.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasMedia](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasMedia.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasMultiplePoll](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasMultiplePoll.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasNoMedia](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasNoMedia.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasPhoto](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasPhoto.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasPoll](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasPoll.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasQuizPoll](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasQuizPoll.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasRoundVideo](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasRoundVideo.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasSinglePoll](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasSinglePoll.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasSticker](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasSticker.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasTopic](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasTopic.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasVideo](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasVideo.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\HasVoice](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/HasVoice.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\Incoming](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/Incoming.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\IsEdited](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/IsEdited.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\IsForwarded](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/IsForwarded.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\IsNotEdited](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/IsNotEdited.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\IsReply](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/IsReply.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\IsReplyToSelf](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/IsReplyToSelf.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\Outgoing](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/Outgoing.html)
* [\danog\MadelineProto\EventHandler\SimpleFilter\Running](/PHP/danog/MadelineProto/EventHandler/SimpleFilter/Running.html)
...
* [\danog\MadelineProto\SettingsGetter](/PHP/danog/MadelineProto/SettingsGetter.html)
...
* [\danog\MadelineProto\EventHandler\Call: Common interface implemented by every call type: one-to-one {@see Calls\PrivateCall} calls, and the](/PHP/danog/MadelineProto/EventHandler/Call.html)
...
* [\danog\MadelineProto\EventHandler\MultiCall: Common interface for the multi-party call types — {@see Calls\GroupCall} (video chats, livestreams),](/PHP/danog/MadelineProto/EventHandler/MultiCall.html)
...
* [\danog\MadelineProto\EventHandler\Calls\AbstractGroupCall: What a [video chat/livestream »](https://core.telegram.org/api/group-calls#video-chats-livestreams)](/PHP/danog/MadelineProto/EventHandler/Calls/AbstractGroupCall.html)
* [\danog\MadelineProto\EventHandler\Calls\AbstractGroupCallMessage: What an in-call message of a video chat ({@see GroupCallMessage}) and of a live story](/PHP/danog/MadelineProto/EventHandler/Calls/AbstractGroupCallMessage.html)
* [\danog\MadelineProto\EventHandler\Calls\AbstractGroupCallParticipant: What a participant of a video chat ({@see GroupCallParticipant}) and of a live story](/PHP/danog/MadelineProto/EventHandler/Calls/AbstractGroupCallParticipant.html)
* [\danog\MadelineProto\EventHandler\Calls\MultiCallMessage: An [in-call message or reaction »](https://core.telegram.org/api/group-calls#in-call-messages) sent in a multi-party call, shown as an overlay by the participants' clients (there is no chat history).](/PHP/danog/MadelineProto/EventHandler/Calls/MultiCallMessage.html)
* [\danog\MadelineProto\EventHandler\Calls\MultiCallParticipant: A participant of a multi-party call, returned by {@see \danog\MadelineProto\EventHandler\MultiCall::getParticipants()}](/PHP/danog/MadelineProto/EventHandler/Calls/MultiCallParticipant.html)
...
* [\danog\MadelineProto\LocalDirectory: Indicates a local directory to write output into.](/PHP/danog/MadelineProto/LocalDirectory.html)
...
* [\danog\MadelineProto\MediaDestination: Which media stream of a call a playback or recording operation targets.](/PHP/danog/MadelineProto/MediaDestination.html)
* [\danog\MadelineProto\Mp4: A pure PHP MP4 (ISO base media file format) demuxer, with the same shape as {@see Matroska}: it](/PHP/danog/MadelineProto/Mp4.html)
...
* [\danog\MadelineProto\RecordingEvent: What happened to a recording, as reported by a {@see EventHandler\Calls\CallStreams} update.](/PHP/danog/MadelineProto/RecordingEvent.html)
* [\danog\MadelineProto\RecordingFormat: Container format of a call recording, as passed to {@see Call::setOutput()} and {@see Call::setOutputFolder()}.](/PHP/danog/MadelineProto/RecordingFormat.html)
...
* [\danog\MadelineProto\EventHandler\Calls\PrivateCall: This update represents a private (one-to-one) VoIP Telegram call.](/PHP/danog/MadelineProto/EventHandler/Calls/PrivateCall.html)
...
* [\danog\MadelineProto\EventHandler\Calls\ConferenceCallParticipant: A participant of an end-to-end encrypted {@see ConferenceCall}, as reconstructed from the](/PHP/danog/MadelineProto/EventHandler/Calls/ConferenceCallParticipant.html)
* [\danog\MadelineProto\EventHandler\Calls\GroupCall: This update represents a Telegram [video chat or livestream »](https://core.telegram.org/api/group-calls#video-chats-livestreams):](/PHP/danog/MadelineProto/EventHandler/Calls/GroupCall.html)
* [\danog\MadelineProto\EventHandler\Calls\GroupCallDonor: A donor of a [live story](https://core.telegram.org/api/group-calls#live-stories), from](/PHP/danog/MadelineProto/EventHandler/Calls/GroupCallDonor.html)
* [\danog\MadelineProto\EventHandler\Calls\GroupCallMessage: An [in-call message or reaction »](https://core.telegram.org/api/group-calls#in-call-messages) sent in a [video chat or livestream »](https://core.telegram.org/api/group-calls#video-chats-livestreams)](/PHP/danog/MadelineProto/EventHandler/Calls/GroupCallMessage.html)
* [\danog\MadelineProto\EventHandler\Calls\GroupCallMessagesDeleted: Some [in-call messages »](https://core.telegram.org/api/group-calls#in-call-messages) of a group call](/PHP/danog/MadelineProto/EventHandler/Calls/GroupCallMessagesDeleted.html)
* [\danog\MadelineProto\EventHandler\Calls\GroupCallParticipant: A participant of a [video chat/livestream »](https://core.telegram.org/api/group-calls#video-chats-livestreams)](/PHP/danog/MadelineProto/EventHandler/Calls/GroupCallParticipant.html)
* [\danog\MadelineProto\EventHandler\Calls\GroupCallParticipants: Participants of a group call joined, left, or changed state (muted, video, volume, raised hand...),](/PHP/danog/MadelineProto/EventHandler/Calls/GroupCallParticipants.html)
* [\danog\MadelineProto\EventHandler\Calls\GroupCallStars: The [Telegram Stars donations](https://core.telegram.org/api/group-calls#paid-live-story-donations)](/PHP/danog/MadelineProto/EventHandler/Calls/GroupCallStars.html)
* [\danog\MadelineProto\EventHandler\Calls\GroupCallState: State of a group call we are interacting with.](/PHP/danog/MadelineProto/EventHandler/Calls/GroupCallState.html)
* [\danog\MadelineProto\EventHandler\Calls\LiveStory: This update represents a Telegram [live story »](https://core.telegram.org/api/group-calls#live-stories):](/PHP/danog/MadelineProto/EventHandler/Calls/LiveStory.html)
* [\danog\MadelineProto\EventHandler\Calls\LiveStoryMessage: An [in-call message or reaction »](https://core.telegram.org/api/group-calls#in-call-messages) sent in a [live story »](https://core.telegram.org/api/group-calls#live-stories) ({@see LiveStory}).](/PHP/danog/MadelineProto/EventHandler/Calls/LiveStoryMessage.html)
* [\danog\MadelineProto\EventHandler\Calls\LiveStoryParticipant: A participant of a [live story »](https://core.telegram.org/api/group-calls#live-stories)](/PHP/danog/MadelineProto/EventHandler/Calls/LiveStoryParticipant.html)
* [\danog\MadelineProto\EventHandler\Calls\PrivateCall: This update represents a private (one-to-one) VoIP Telegram call.](/PHP/danog/MadelineProto/EventHandler/Calls/PrivateCall.html)
...
* [\danog\MadelineProto\EventHandler\Message\Service\DialogConferenceCall: A service message about an [end-to-end encrypted conference call »](https://core.telegram.org/api/group-calls#conference-calls):](/PHP/danog/MadelineProto/EventHandler/Message/Service/DialogConferenceCall.html)
...
* [\danog\MadelineProto\Tgcalls\E2E\ConferenceCall: Controller for a Telegram end-to-end encrypted conference call](/PHP/danog/MadelineProto/Tgcalls/E2E/ConferenceCall.html)
