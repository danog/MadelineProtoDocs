...
* [\danog\MadelineProto\Test\CallRecorderSegmentsTest: The recorder follows the party turning its mic, camera and screen share on and off: every change of](/PHP/danog/MadelineProto/Test/CallRecorderSegmentsTest.html)
...
* [\danog\MadelineProto\RecordingFormat: Container format of a call recording, as passed to {@see Call::setOutput()}.](/PHP/danog/MadelineProto/RecordingFormat.html)
...
* [\danog\MadelineProto\EventHandler\Calls\GroupCallMessage: An [in-call message or reaction »](https://core.telegram.org/api/group-calls#in-call-messages) sent in](/PHP/danog/MadelineProto/EventHandler/Calls/GroupCallMessage.html)
...
* [\danog\MadelineProto\GroupCall\GroupCallDonor: A donor of a [live story](https://core.telegram.org/api/group-calls#live-stories), from](/PHP/danog/MadelineProto/GroupCall/GroupCallDonor.html)
* [\danog\MadelineProto\GroupCall\GroupCallStars: The [Telegram Stars donations](https://core.telegram.org/api/group-calls#paid-live-story-donations)](/PHP/danog/MadelineProto/GroupCall/GroupCallStars.html)
