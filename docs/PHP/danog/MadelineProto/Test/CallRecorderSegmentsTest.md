---
title: "danog\\MadelineProto\\Test\\CallRecorderSegmentsTest: The recorder follows the party turning its mic, camera and screen share on and off: every change of"
description: "the flowing streams closes the file and continues in `<base>.N.mkv` with exactly those streams.\n"
