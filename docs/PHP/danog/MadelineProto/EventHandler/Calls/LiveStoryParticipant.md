---
title: "danog\\MadelineProto\\EventHandler\\Calls\\LiveStoryParticipant: A participant of a [live story »](https://core.telegram.org/api/group-calls#live-stories)"
description: "({@see LiveStory}): a {@see groupCallParticipant} that additionally carries the Telegram Stars the\nparticipant has donated ({@see self::$paidStarsTotal}).\n"
image: "https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png"
parent: "MadelineProto API"

---
# `danog\MadelineProto\EventHandler\Calls\LiveStoryParticipant`
...
## Properties
* `$paidStarsTotal`: `?int` Total Telegram Stars donated by this participant, if any.
