---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogConferenceCall: A service message about an [end-to-end encrypted conference call »](https://core.telegram.org/api/group-calls#conference-calls):"
description: "an invitation to one (incoming or outgoing), a missed one, or one that ended.\n"
image: "https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png"
parent: "MadelineProto API"

---
# `danog\MadelineProto\EventHandler\Message\Service\DialogConferenceCall`
...
## Properties
* `$callId`: `int` ID of the conference call.
* `$missed`: `bool` Whether we missed the call.
* `$active`: `bool` Whether the call is still active.
* `$video`: `bool` Whether this is a video call.
* `$duration`: `?int` Duration of the call in seconds, if it ended.
* `$otherParticipants`: `list<int>` Bot API IDs of the other participants of the call.
* `$id`: `int` Message ID
...
## Method list:
* [`join(bool $muted = false): \danog\MadelineProto\EventHandler\Calls\ConferenceCall`](#join)
...
## Methods:
### <a name="join"></a> `join(bool $muted = false): \danog\MadelineProto\EventHandler\Calls\ConferenceCall`
