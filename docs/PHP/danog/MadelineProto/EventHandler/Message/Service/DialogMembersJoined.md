...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, array $joined)`](#__construct-danog-madelineproto-mtproto-api-array-rawmessage-array-info-array-joined)
...
## Methods:
### `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, array $joined)`
