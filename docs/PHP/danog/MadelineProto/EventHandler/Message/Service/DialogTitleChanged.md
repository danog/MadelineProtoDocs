...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, string $title)`](#__construct-danog-madelineproto-mtproto-api-array-rawmessage-string-title)
...
## Methods:
### `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, string $title)`
