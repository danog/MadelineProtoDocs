---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogChatMigrateTo: Indicates the chat was [migrated](https://core.telegram.org/api/channel) to the specified supergroup."
description: ""
...
## Properties
* `$channelId`: `int` The supergroup it was migrated to
* `$id`: `int` Message ID
...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, int $channelId)`](#__construct-danog-madelineproto-mtproto-api-array-rawmessage-array-info-int-channelid)
...
## Methods:
### `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, int $channelId)`
