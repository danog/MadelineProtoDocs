---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogSetChatTheme: The chat theme was changed."
description: ""
...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, string $emoticon)`](#__construct-danog-madelineproto-mtproto-api-array-rawmessage-array-info-string-emoticon)
...
## Methods:
### `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, string $emoticon)`
