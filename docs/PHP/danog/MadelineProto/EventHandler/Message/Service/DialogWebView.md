...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, string $text, ?string $data)`](#__construct-danog-madelineproto-mtproto-api-array-rawmessage-array-info-string-text-string-data)
