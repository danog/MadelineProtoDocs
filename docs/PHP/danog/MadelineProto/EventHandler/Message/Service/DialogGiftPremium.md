...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, string $currency, int $amount, int $months, ?int $cryptoCurrency, ?int $cryptoAmount)`](#__construct)
...
## Methods:
### <a name="__construct"></a> `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, string $currency, int $amount, int $months, ?int $cryptoCurrency, ?int $cryptoAmount)`
