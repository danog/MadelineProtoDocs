---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogGiftPremium: Info about a gifted Telegram Premium subscription."
description: ""
...
## Properties
* `$currency`: `string` Three-letter ISO 4217 [currency](https://core.telegram.org/bots/payments#supported-currencies) code
...
* `$cryptoCurrency`: `?int` If the gift was bought using a cryptocurrency, the cryptocurrency name.
* `$cryptoAmount`: `?int` If the gift was bought using a cryptocurrency, price of the gift in the smallest units of a cryptocurrency.
* `$id`: `int` Message ID
...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, string $currency, int $amount, int $months, ?int $cryptoCurrency, ?int $cryptoAmount)`](#__construct-danog-madelineproto-mtproto-api-array-rawmessage-array-info-string-currency-int-amount-int-months-int-cryptocurrency-int-cryptoamount)
...
## Methods:
### `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, string $currency, int $amount, int $months, ?int $cryptoCurrency, ?int $cryptoAmount)`
