...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, int $scheduleDate)`](#__construct-danog-madelineproto-mtproto-api-array-rawmessage-array-info-int-scheduledate)
...
## Methods:
### `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, int $scheduleDate)`
