---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogGroupCall\\GroupCallScheduled: A group call was scheduled."
description: ""
...
## Properties
* `$scheduleDate`: `int` When is this group call scheduled to start
...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, int $id, int $accessHash, int $scheduleDate)`](#__construct-danog-madelineproto-mtproto-api-array-rawmessage-array-info-int-id-int-accesshash-int-scheduledate)
...
## Methods:
### `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, int $id, int $accessHash, int $scheduleDate)`
