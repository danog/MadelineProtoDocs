---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogGroupCall\\GroupCallEnded: The group call has ended."
description: ""
image: "https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png"
parent: "MadelineProto API"

---
# `danog\MadelineProto\EventHandler\Message\Service\DialogGroupCall\GroupCallEnded`
...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, int $id, int $accessHash, int $duration)`](#__construct-danog-madelineproto-mtproto-api-array-rawmessage-array-info-int-id-int-accesshash-int-duration)
...
## Methods:
### `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, int $id, int $accessHash, int $duration)`
