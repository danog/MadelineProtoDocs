---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogGroupCall\\GroupCall: The group call has started or ended."
description: ""
...
## Properties
* `$ended`: `bool` Whether that group call ended or not.
...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, ?int $duration)`](#__construct-danog-madelineproto-mtproto-api-array-rawmessage-array-info-int-duration)
...
## Methods:
### `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, ?int $duration)`
