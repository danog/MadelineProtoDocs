...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, int $id, int $accessHash, array $users)`](#__construct-danog-madelineproto-mtproto-api-array-rawmessage-array-info-int-id-int-accesshash-array-users)
...
## Methods:
### `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, int $id, int $accessHash, array $users)`
