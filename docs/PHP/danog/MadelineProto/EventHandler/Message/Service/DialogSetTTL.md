---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogSetTTL: The Time-To-Live of messages in this chat was changed."
description: ""
...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, int $period, ?int $autoSettingFrom)`](#__construct-danog-madelineproto-mtproto-api-array-rawmessage-array-info-int-period-int-autosettingfrom)
...
## Methods:
### `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, int $period, ?int $autoSettingFrom)`
