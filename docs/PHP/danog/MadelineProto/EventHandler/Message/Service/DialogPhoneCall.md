...
## Methods:
### <a name="__construct"></a> `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, bool $video, int $callId, ?\danog\MadelineProto\VoIP\DiscardReason $reason, ?int $duration)`
