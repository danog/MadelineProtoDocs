---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogPaymentSent: A payment was sent."
description: ""
image: "https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png"
parent: "MadelineProto API"

---
# `danog\MadelineProto\EventHandler\Message\Service\DialogPaymentSent`
...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, ?bool $recurringInit, ?bool $recurringUsed, string $currency, int $totalAmount, ?string $invoiceSlug, ?int $subscriptionUntilDate)`](#__construct)
...
## Methods:
### <a name="__construct"></a> `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, ?bool $recurringInit, ?bool $recurringUsed, string $currency, int $totalAmount, ?string $invoiceSlug, ?int $subscriptionUntilDate)`
