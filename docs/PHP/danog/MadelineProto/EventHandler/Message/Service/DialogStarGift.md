---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogStarGift: Info about a Star gifted."
description: ""
image: "https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png"
parent: "MadelineProto API"

---
# `danog\MadelineProto\EventHandler\Message\Service\DialogStarGift`
...
## Properties
* `$hide`: `?bool` Show the name of sender hide or no
* `$saved`: `?bool` Show the gift is saved on profile or no
* `$converted`: `?bool` Show the gift is converted to stars or no
* `$gift`: `danog\MadelineProto\EventHandler\Payments\StarGift` The gift
* `$message`: `?danog\MadelineProto\EventHandler\Message\Entities\TextWithEntities` Styled text that sender of gift provided
* `$convertStars`: `?int` Amount of stars after the gift converted
* `$id`: `int` Message ID
