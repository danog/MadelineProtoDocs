---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogMessagePinned: A message was pinned in a chat."
description: ""
...
## Method list:
* [`getPinnedMessage(class-string<T> $class = 'danog\\MadelineProto\\EventHandler\\AbstractMessage'): ?T`](#getPinnedMessage)
...
## Methods:
### <a name="getPinnedMessage"></a> `getPinnedMessage(class-string<T> $class = 'danog\\MadelineProto\\EventHandler\\AbstractMessage'): ?T`
