---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogPaymentSentMe: A user just sent a payment to me (a bot)."
description: ""
image: "https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png"
parent: "MadelineProto API"

---
# `danog\MadelineProto\EventHandler\Message\Service\DialogPaymentSentMe`
...
* `$totalAmount`: `int` Price of the product in the smallest units of the currency
* `$payload`: `danog\MadelineProto\TL\Types\Bytes` Bot specified invoice payload
* `$paymentInfo`: `?danog\MadelineProto\EventHandler\Payments\PaymentRequestedInfo` Order info provided by the user
* `$shippingOptionId`: `?string` Identifier of the shipping option chosen by the user
* `$charge`: `danog\MadelineProto\EventHandler\Payments\PaymentCharge` Provider payment identifier
* `$subscriptionUntilDate`: `?int` The date that subscription has been ended
* `$id`: `int` Message ID
...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, ?bool $recurringInit, ?bool $recurringUsed, string $currency, int $totalAmount, \danog\MadelineProto\TL\Types\Bytes $payload, ?\danog\MadelineProto\EventHandler\Payments\PaymentRequestedInfo $paymentInfo, ?string $shippingOptionId, \danog\MadelineProto\EventHandler\Payments\PaymentCharge $charge, ?int $subscriptionUntilDate)`](#__construct)
* [`refundStars(int $userId): void`](#refundStars)
...
## Methods:
### <a name="__construct"></a> `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, ?bool $recurringInit, ?bool $recurringUsed, string $currency, int $totalAmount, \danog\MadelineProto\TL\Types\Bytes $payload, ?\danog\MadelineProto\EventHandler\Payments\PaymentRequestedInfo $paymentInfo, ?string $shippingOptionId, \danog\MadelineProto\EventHandler\Payments\PaymentCharge $charge, ?int $subscriptionUntilDate)`
...
* `$currency`: `string`   
* `$totalAmount`: `int`   
* `$payload`: `\danog\MadelineProto\TL\Types\Bytes`   
* `$paymentInfo`: `?\danog\MadelineProto\EventHandler\Payments\PaymentRequestedInfo`   
* `$shippingOptionId`: `?string`   
* `$charge`: `\danog\MadelineProto\EventHandler\Payments\PaymentCharge`   
...
* [\danog\MadelineProto\EventHandler\Payments\PaymentRequestedInfo](../../../../../danog/MadelineProto/EventHandler/Payments/PaymentRequestedInfo.html)
* [`\danog\MadelineProto\EventHandler\Payments\PaymentCharge`: Payment identifier.](../../../../../danog/MadelineProto/EventHandler/Payments/PaymentCharge.html)




### <a name="refundStars"></a> `refundStars(int $userId): void`
