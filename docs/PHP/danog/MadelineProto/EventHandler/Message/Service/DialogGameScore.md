---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogGameScore: Someone scored in a game."
description: ""
...
## Method list:
* [`__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, int $gameId, int $score)`](#__construct-danog-madelineproto-mtproto-api-array-rawmessage-array-info-int-gameid-int-score)
...
## Methods:
### `__construct(\danog\MadelineProto\MTProto $API, array $rawMessage, array $info, int $gameId, int $score)`
