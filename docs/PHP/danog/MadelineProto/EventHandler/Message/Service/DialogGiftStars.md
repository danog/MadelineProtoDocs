---
title: "danog\\MadelineProto\\EventHandler\\Message\\Service\\DialogGiftStars: Info about a gifted Telegram Stars."
description: ""
image: "https://docs.madelineproto.xyz/favicons/android-chrome-256x256.png"
parent: "MadelineProto API"

---
# `danog\MadelineProto\EventHandler\Message\Service\DialogGiftStars`
...
* `$amount`: `int` Price of the gift in the smallest units of the currency (integer, not float/double).
