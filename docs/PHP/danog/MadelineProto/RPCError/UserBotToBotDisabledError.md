---
title: "danog\\MadelineProto\\RPCError\\UserBotToBotDisabledError: Bot-to-bot messaging is disabled because one of the two bots hasn't enabled the Bot to Bot setting in @BotFather."
...
---
# `danog\MadelineProto\RPCError\UserBotToBotDisabledError`
