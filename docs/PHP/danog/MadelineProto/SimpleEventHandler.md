...
* [`getReportPeers(): string|int|(string|int)[]`](#getreportpeers)
* [`getPluginPaths(): \non-empty-string|\non-empty-list<\non-empty-string>|null`](#getpluginpaths)
* [`getPlugins(): class-string<\danog\MadelineProto\EventHandler>[]`](#getplugins)
