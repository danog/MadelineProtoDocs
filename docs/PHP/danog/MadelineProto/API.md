...
* [`__construct(string $session, \danog\MadelineProto\SettingsAbstract $settings = NULL)`](#__construct-string-session-danog-madelineproto-settingsabstract-settings-null)
