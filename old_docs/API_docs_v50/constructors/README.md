...
***
<br><br>[$account.chatThemes](../constructors/account.chatThemes.md) = \['hash' => [int](../types/int.md), 'themes' => \[[ChatTheme](../types/ChatTheme.md)\], \];<a name="account.chatThemes"></a>  

***
<br><br>[$account.chatThemesNotModified](../constructors/account.chatThemesNotModified.md) = \[\];<a name="account.chatThemesNotModified"></a>  
...
***
<br><br>[$channelParticipantSelf](../constructors/channelParticipantSelf.md) = \['user_id' => [long](../types/long.md), 'inviter_id' => [long](../types/long.md), 'date' => [int](../types/int.md), \];<a name="channelParticipantSelf"></a>  
...
***
<br><br>[$chatFull](../constructors/chatFull.md) = \['can_set_username' => [Bool](../types/Bool.md), 'has_scheduled' => [Bool](../types/Bool.md), 'id' => [long](../types/long.md), 'about' => [string](../types/string.md), 'participants' => [ChatParticipants](../types/ChatParticipants.md), 'chat_photo' => [Photo](../types/Photo.md), 'notify_settings' => [PeerNotifySettings](../types/PeerNotifySettings.md), 'exported_invite' => [ExportedChatInvite](../types/ExportedChatInvite.md), 'bot_info' => \[[BotInfo](../types/BotInfo.md)\], 'pinned_msg_id' => [int](../types/int.md), 'folder_id' => [int](../types/int.md), 'call' => [InputGroupCall](../types/InputGroupCall.md), 'ttl_period' => [int](../types/int.md), 'groupcall_default_join_as' => [Peer](../types/Peer.md), 'theme_emoticon' => [string](../types/string.md), \];<a name="chatFull"></a>  
...
***
<br><br>[$chatInviteExported](../constructors/chatInviteExported.md) = \['revoked' => [Bool](../types/Bool.md), 'permanent' => [Bool](../types/Bool.md), 'link' => [string](../types/string.md), 'admin_id' => [long](../types/long.md), 'date' => [int](../types/int.md), 'start_date' => [int](../types/int.md), 'expire_date' => [int](../types/int.md), 'usage_limit' => [int](../types/int.md), 'usage' => [int](../types/int.md), \];<a name="chatInviteExported"></a>  

***
<br><br>[$chatInviteImporter](../constructors/chatInviteImporter.md) = \['user_id' => [long](../types/long.md), 'date' => [int](../types/int.md), \];<a name="chatInviteImporter"></a>  
...
***
<br><br>[$chatTheme](../constructors/chatTheme.md) = \['emoticon' => [string](../types/string.md), 'theme' => [Theme](../types/Theme.md), 'dark_theme' => [Theme](../types/Theme.md), \];<a name="chatTheme"></a>  
...
***
<br><br>[$sponsoredMessage](../constructors/sponsoredMessage.md) = \['from_id' => [Peer](../types/Peer.md), 'start_param' => [string](../types/string.md), 'message' => [string](../types/string.md), 'entities' => \[[MessageEntity](../types/MessageEntity.md)\], \];<a name="sponsoredMessage"></a>  
