...
***
<br><br>[$updateBotInlineSend](../constructors/updateBotInlineSend.md) = \['user_id' => [int](../types/int.md), 'query' => [string](../types/string.md), 'id' => [string](../types/string.md), \];<a name="updateBotInlineSend"></a>  
