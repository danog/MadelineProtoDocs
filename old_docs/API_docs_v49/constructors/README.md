...
***
<br><br>[$updateBotCommands](../constructors/updateBotCommands.md) = \['peer' => [Peer](../types/Peer.md), 'bot_id' => [int](../types/int.md), 'commands' => \[[BotCommand](../types/BotCommand.md)\], \];<a name="updateBotCommands"></a>  
