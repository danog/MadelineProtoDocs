...
$messages.StatedMessage = $MadelineProto->messages->forwardMessage(['peer' => InputPeer, 'id' => int, ]);
```

Or, if you're into Lua:

```lua
messages.StatedMessage = messages.forwardMessage({peer=InputPeer, id=int, })
```
