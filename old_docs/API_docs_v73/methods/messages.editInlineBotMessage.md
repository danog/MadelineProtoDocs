...
```lua
Bool = messages.editInlineBotMessage({no_webpage=Bool, stop_geo_live=Bool, id=InputBotInlineMessageID, message='string', reply_markup=ReplyMarkup, entities={MessageEntity}, parseMode='string', geo_point=InputGeoPoint, })
```
