...
***
<br><br>
$MadelineProto->[test->useConfigSimple](test.useConfigSimple.md)(\[\]) === [$help.ConfigSimple](../types/help.ConfigSimple.md)<a name="test.useConfigSimple"></a>  

***
<br><br>
$MadelineProto->[test->useError](test.useError.md)(\[\]) === [$Error](../types/Error.md)<a name="test.useError"></a>  
